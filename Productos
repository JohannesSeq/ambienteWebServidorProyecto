...
<head>
    ...
    <title>Gestión de Facturas y Productos - Restaurante Playa Cacao</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="jumbotron">
            ...
            <p class="lead">Seleccione una opción para gestionar Productos</p>
            <hr class="my-4">
            <div class="d-flex justify-content-around">
                <a class="btn button-62" href="#" role="button">Agregar Inventario</a>
                <a class="btn button-62" href="#" role="button">Modificar Producto</a>
                <a class="btn button-62" href="#" role="button">Mostrar Inventario</a>
                <a class="btn button-62" href="#" role="button">Dashboard de Inventario</a>
                <a class="btn button-62" href="#" role="button">Gestión de Pedidos</a>
            </div>
        </div>
    </div>
